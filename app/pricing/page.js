...
const PLANS = [
  {
    ...
    price: 0,
    period: "للأبد",
    line: "كل اللي تحتاجه عشان تحسم يومك.",
    features: [
      "١٠ قرارات في الشهر",
      "سجل آخر ١٠ قرارات",
      ...
      >
        ...
        <section className="flex flex-col gap-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              {
                q: "أحتاج حساب عشان أستخدم احسم؟",
                a: "لا. تقدر تحسم بلا حساب أبداً — الحساب للحفظ فقط، عشان يبقى لك سجل ونقرأ منه أنماطك.",
              },
              {
                q: "وش يصير لقراراتي لو وقفت الاشتراك؟",
                a: "تبقى مكانها. ترجع لحدود المجاني في الجديد، وسجلك القديم ما ينحذف.",
              },
              {
                q: "ليش خطة اليوم وتحليل المخاطر خلف الاشتراك؟",
                a: "لأنهما الأغلى تشغيلاً: خطة اليوم تنادي أماكن حقيقية وطقساً مع كل طلب، والتحليل سلسلة نداءات لا نداءً واحداً.",
              },
              {
                q: "أقدر ألغي متى ما أبي؟",
                a: "إي. الإلغاء من الإعدادات، ويكمل اشتراكك للفترة اللي دفعتها.",
              },
            ].map((item) => (
              <div
                key={item.q}
