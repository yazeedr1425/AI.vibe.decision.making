...
export const CATEGORIES = [
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          { value: "now", label: "المهم الحين", en: "RIGHT NOW", weight: 1 },
        ],
      },
      {
        key: "necessity",
    ...
    questions: [
      {
        ...
        choices: [
          ...
          { value: "none", label: "ولا شي", en: "NONE", weight: 1 },
        ],
      },
      {
        key: "energy",
...

  {
    ...
    criteria: [
      { key: "align", label: "يخدم هدفك", low: "بعيد عن أهدافي", high: "يقربني لهدفي" },
      { key: "risk", label: "قابل للتراجع", low: "صعب أرجع عنه", high: "أقدر أعدله بعدين" },
      { key: "gut", label: "ارتياحك له", low: "مرتبك منه", high: "مرتاح له" },
    ],
    questions: [
      {
        key: "stakes",
