...
//
// responseSchema في مسار الـ API يفرض شكل JSON، فتنظيف ```json صار
// حزام أمان رخيص لا الطبقة الأساسية.
//
// أما التحقق من place_id فيبقى ضرورياً تماماً: المخطط يضمن أن الحقل
// نص موجود، ما يضمن أن النص يشير لمكان حقيقي أرسلناه. النموذج قادر
// يخترع معرّفاً بشكل سليم لمطعم ما وجد أصلاً — وهذا بالضبط ما نمنعه.
